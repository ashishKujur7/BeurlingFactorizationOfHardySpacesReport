...
\fancypagestyle{myheader}{
    ...
    \fancyhead[CO]{\textsc{\leftmark}} %How to insert the Chapter names like "MyChapter"?
    \fancyfoot[C]{\thepage}
...
\newcommand{\ttle}{A Study of $H^{p}$ spaces and Inner Outer Factorization of functions in $H^{p}$ spaces}

\title{
{Study of Inner Outer Factorization of Hardy Spaces}\\
{\large Indian Institute of Science Education and Research -- Thiruvananthapuram}\\ \vspace{1cm}
{\includegraphics[height=0.1\textheight]{iiser_logo.png}}
}
\author{Ashish Kujur}
...
\input{03a_Certificate}
% \input{00_Intro_Pages/03b_Certificate}

\input{04_Acknowledgements}
\input{06_ToC,LoF,LoT}
%\tableofcontents
\setcounter{page}{1}
\include{analytic-harmonic.tex}
\include{h1.tex}
\include{factorizationForHpFunctions.tex}
\nocite{*}
